                ...
                <td className="py-4 px-4">
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                      <span className="text-sm font-semibold text-primary-green">{appointment.avatar}</span>
                    </div>
                    <div>
                      <div className="text-sm font-semibold text-off-white">{appointment.name}</div>
                      <div className="text-sm text-medium-gray">{appointment.email}</div>
                    </div>
                  </div>
                </td>
                <td className="py-4 px-4 text-sm text-off-white">{appointment.date}</td>
                <td className="py-4 px-4 text-sm text-off-white">{appointment.time}</td>
                <td className="py-4 px-4 text-sm text-off-white">{appointment.doctor}</td>
                <td className="py-4 px-4">
